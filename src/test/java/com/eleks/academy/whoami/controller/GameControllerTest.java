...
class GameControllerTest {
    ...
    void createGame() throws Exception {
        ...
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("id").value("16527053"))
    ...
    @Test
    void enrollGame() throws Exception {
        this.mockMvc.perform(
                        MockMvcRequestBuilders.post("/games/1234")
                                .header("X-Player", "player")
                                .contentType(MediaType.APPLICATION_JSON)
                                .content("{\n" +
                                        "    \"player\": \" char\"\n" +
                                        "}"))
                .andExpect(status().isOk());
        verify(gameService, times(1)).enrollToGame(eq("1234"), eq("player"));
    }
